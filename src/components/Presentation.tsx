  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between select-none overflow-hidden font-sans">
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8 max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="w-full h-full min-h-[500px] md:min-h-[580px] bg-gradient-to-br from-slate-900 via-[#001F3F] to-slate-950 rounded-2xl border border-amber-400/40 shadow-2xl p-8 md:p-14 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="flex items-center justify-between pt-6 border-t border-slate-800 text-xs text-slate-400">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold transition shadow-lg shadow-amber-400/20"
              >
                Proceed to Feedback Form <ChevronRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        )}
        ...
        {currentSlide === 11 && (
          <div className="w-full h-full min-h-[500px] md:min-h-[580px] bg-gradient-to-br from-slate-900 via-[#001F3F] to-slate-950 rounded-2xl border border-amber-400/50 shadow-2xl p-6 md:p-10 flex flex-col justify-between relative overflow-hidden">
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <div>
                <span className="text-xs font-bold text-amber-400 uppercase tracking-widest">WORKSHOP ATTENDANCE & FEEDBACK</span>
                <h2 className="text-2xl md:text-4xl font-black text-slate-50 font-['Montserrat']">FEEDBACK FORM</h2>
              </div>
              <div className="p-3 rounded-xl bg-amber-400 text-slate-950 font-bold flex items-center gap-2 shadow-lg shadow-amber-400/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 my-auto py-4 items-center">
              ...
              <div className="md:col-span-5 flex flex-col items-center justify-center">
                <div className="bg-white p-4 md:p-6 rounded-2xl shadow-2xl border-4 border-amber-400 text-center space-y-3 relative group">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-400 text-slate-950 text-[10px] font-extrabold px-3 py-0.5 rounded-full uppercase tracking-wider shadow">
                    Scan With Phone Camera
                  </div>
                  <img
                    src="/qr-code.png"
                    alt="GSET Workshop Feedback Form QR Code"
                    className="w-48 h-48 md:w-56 md:h-56 object-contain mx-auto transition-transform duration-300 group-hover:scale-105"
                  />
                  <p className="text-xs text-slate-700 font-semibold font-mono">Feedback & Attendance Form</p>
                </div>
              </div>

              {/* Right Column: Attendance Instructions & Badge */}
              <div className="md:col-span-7 space-y-6">
                <div className="bg-slate-900/80 rounded-xl p-6 border border-slate-800 space-y-3">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 p-5 rounded-xl bg-slate-950/70 border border-amber-400/30">
                  <div className="flex items-center gap-3">
                    <div className="p-3 rounded-lg bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                      <ShieldCheck className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="text-sm font-extrabold text-slate-100 tracking-wide font-['Montserrat']">GSET</h4>
                      <p className="text-xs text-slate-400 uppercase tracking-widest font-semibold">Supporting Excellence in Teaching</p>
                    </div>
                  </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-800 text-xs text-slate-400">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-amber-400 font-semibold transition border border-slate-700"
              >
                Back to Start
              </button>
            </div>
